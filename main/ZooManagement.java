...
public class ZooManagement {
    ...
    //    // tn.esprit.gestionzoo.entities.Zoo myZoo1 = new tn.esprit.gestionzoo.entities.Zoo("Parc Animalier", "Tunis", 20);
        ...
        Animal tigre = new Animal("Félidé", "Shere Khan", 7, true);
        Animal lion = new Animal("Félidé", "Lion", 5, true); // identique à lion
        // Test Ajout
        myZoo.addAnimal(lion);
        myZoo.addAnimal(tigre);
        Dolphin d1 = new Dolphin("Delphinidae", "Flipper", 6, true, "Sea", 25.5f);
        Penguin p1 = new Penguin("Spheniscidae", "Pingo", 3, false, "Iceberg", 15.0f);
        myZoo.addAnimal(d1);
        myZoo.addAnimal(p1);
        Aquatic[] aquaticAnimals = new Aquatic[10];
        Aquatic.addAquatic(aquaticAnimals, d1);
        for( Aquatic a: aquaticAnimals) {
           // a.swim();
            System.err.println("Aquatic itself does not have real swim() behavior after abstarct");
        }
        myZoo.getMaxPenguinDepth();
