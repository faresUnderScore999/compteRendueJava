...
public class Zoo {
    ...
    // ✅ Instruction 28 : Obtenir la profondeur maximale des pingouins
    ...
    // ✅ Instruction 28 : Afficher le nombre des dauphins et des pingouins
    public void displayNumberOfAquaticsByType() {
        int dolphinCount = 0;
        int penguinCount = 0;

        for (int i = 0; i < animalCount; i++) {
            if (animals[i].getClass() == Dolphin.class) {
                dolphinCount++;
            } else if (animals[i].getClass() == Penguin.class ) {
                penguinCount++;
            }
        }
